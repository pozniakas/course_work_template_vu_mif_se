...
Pavyzdinis tekstas:
Kaip tolimesnė ateities darbų kryptis siūloma sukurti atskirą sistemą, karkasą, kuris kombinuotų
aptartus prevencijos būdus su tikslu efektyviai padengti visas interneto svetainės dalis, taip
minimizuojant individualių prevencijos būdų silpnybes. Siekiant ištestuoti sukurtos sistemos
efektyvumą būtina įgyvendinti saityno duomenų ištraukėjo funkcionalumą arba pasirinkti kelias
komercines automatizuoto duomenų surinkimo iš tinklalapių priemones. Vienas iš tikslų gali būti
palyginti sukurtą sistemą pagal kriterijus, metrikas (pavyzdžiui, ar skriptas sėkmingai/nesėkmingai
įvykdė duomenų surinkimą) su kitomis komercinėmis automatizuoto duomenų surinkimo iš
tinklalapių priemonėmis, paslaugomis.
