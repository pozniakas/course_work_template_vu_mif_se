...
\begin{table}[H]\footnotesize
  ...
  {\begin{tabular}{|l|c|c|} \hline
     & „Agile“ & „Lean“ \\
    \hline
    Galvoja apie & Klientus & Elimnuoti laiko švaistymą      \\
    \hline
    Tvarko & Neapibrėžtumą & Procesų trukmę       \\
    \hline
    Suteikia & Veikiantį produktą    & Vertę leidimuose       \\
    \hline
...
\begin{table}[H]\footnotesize
  ...
  {\begin{tabular}{|l|p{55mm}|p{55mm}|} \hline
    ...
    \hline
    Panaudojimo būdai & Kodo peržiūra, testavimas, kokybės užtikrinimo aplinkos alternatyva & Testavimo, kokybės užtikrinimo ir produkcinės statinės aplinkos      \\
    \hline
    ...
    \hline
    Verifikacijos etapas  & Vyksta prieš suliejimą į statines aplinkas & Vyksta po suliejimo į statines aplinkas \\
    \hline
  \end{tabular}}
  \label{tab:table example}
\end{table}
...
% TODO: Pakeisti kodo pav į tikrą kodą